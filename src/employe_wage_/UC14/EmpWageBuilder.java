...
public class EmpWageBuilder implements IEmpWageBuilder{
    ...
    public static void main(String[] args) {
        ...
        String companyNameToQuery = "Company1";
        int totalWage = empWageBuilder.getTotalWageByCompany(companyNameToQuery);
        System.out.println("Total Wage for " + companyNameToQuery + ": " + totalWage);
    }
}
